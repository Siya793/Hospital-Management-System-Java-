...
public class HospitalManagementSystemDriver {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Doctors doctor = new Doctors(connection, scanner); // Fixed: Pass 2 arguments
    ...
    public static void bookAppointment(Patient patient, Doctors doctor, Connection connection, Scanner scanner) {
        ...
        if (patient.getPatientById(patientId) && doctor.getDoctorsById(doctorId)) {
            if (checkDoctorAvailability(doctorId, appointmentDate, connection)) {
                ...
                try {
                    PreparedStatement preparedStatement = connection.prepareStatement(appointmentQuery); // Fixed
